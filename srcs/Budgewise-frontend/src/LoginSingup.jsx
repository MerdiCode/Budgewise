...
function LogSignIn() {
  ...
  const addUser = async () => {
    ...
    try {
      const response = await axios.post('https://troubled-past-drop.glitch.me/users/SignUp/',
  ...
  const logIn = async () => {
    try {
      const response = await axios.post('https://troubled-past-drop.glitch.me/users/LogIn', { logEmail, logPass }, { withCredentials: true })
