...
function LogSignIn() {
  ...
  const addUser = async () => {
    ...
    try {
      const response = await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/SignUp/',
  ...
  const logIn = async () => {
    try {
      const response = await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/LogIn', { logEmail, logPass }, { withCredentials: true })
