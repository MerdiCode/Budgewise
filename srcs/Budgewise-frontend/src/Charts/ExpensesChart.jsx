...
class Expenses extends Component {
  ...
  loadDailyData = async () => {
    ...
    const daily = await axios.get(
      "https://backendbudgewise-2.onrender.com/users/getDailyExpenses/",
  ...
  changeOptions = async (val) => {
    ...
    let daily = await axios.get('https://backendbudgewise-2.onrender.com/users/getDailyExpenses/', { withCredentials: true });
    let weekly = await axios.get('https://backendbudgewise-2.onrender.com/users/getWeeklyExpenses/', { withCredentials: true });
    let monthly = await axios.get('https://backendbudgewise-2.onrender.com/users/getMonthlyExpenses/', { withCredentials: true });
    let yearly = await axios.get('https://backendbudgewise-2.onrender.com/users/getYerlyExpenses/', { withCredentials: true });
