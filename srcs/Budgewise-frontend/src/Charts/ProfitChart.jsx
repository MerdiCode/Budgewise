...
class ProfitChart extends Component {
    ...
    loadDailyData = async () => {
      ...
      const daily = await axios.get(
        "http://localhost:4001/users/getDailyProfit/",
    ...
    changeOptions = async (val) => {
      ...
      let daily = await axios.get('http://localhost:4001/users/getDailyProfit/', { withCredentials: true });
      let weekly = await axios.get('http://localhost:4001/users/getWeeklyProfit/', { withCredentials: true });
      let monthly = await axios.get('http://localhost:4001/users/getMonthlyProfit/', { withCredentials: true });
      let yearly = await axios.get('http://localhost:4001/users/getYerlyProfit/', { withCredentials: true });
