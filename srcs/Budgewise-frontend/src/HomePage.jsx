...
function HomePage() {
   ...
   let [goalMsg,setGoalMsg] = useState();
    ...
    useEffect(() => {
        const getGoal = async () => {
            try {
                const goal = await axios.get("https://gorgeous-actually-hydrangea.glitch.me/users/getGoal/", { withCredentials: true });
    ...
    useEffect(() => {
        const updateBalance = async () => {
            try {
                await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/postBalance/', { balance }, { withCredentials: true })
            } catch (error) {
                if (error) {
                    console.error(error)
                }
    ...
    useEffect(() => {
        const ProfExp = async () => {
            ...
            try {
                const AddProfVsExp = await axios.get("https://gorgeous-actually-hydrangea.glitch.me/users/getProfVsExp/", { withCredentials: true });
    ...
    const DeleteExpensesList = async (ExpensesID) => {
        try {
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/delExpenses/', { ExpensesID }, { withCredentials: true })
            getExpenses();
        } catch (error) {
            console.error(error)
        }
    ...
    const DeleteProfitList = async (ProfitID) => {
        try {
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/delProfit/', { ProfitID }, { withCredentials: true })
            getProfit();
        } catch (error) {
            console.error(error)
        }
    ...
    const updateProfVsExp = async (profit, expenses) => {
        ...
        try {
            await axios.post("https://gorgeous-actually-hydrangea.glitch.me/users/profExp/", { profExpE, profExpP }, { withCredentials: true });
        } catch (err) {
            console.error(err)
        }
    }
    const CreateGoal = async (amount) => {
        setGoalD(amount)
        try {
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/updateGoal/', { amount }, { withCredentials: true })
        } catch (error) {
            if (error) {
                console.error(error)
            }
    ...
    const postProfit = async () => {
        ...
        try {
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/Profit/', { profitData }, { withCredentials: true })
    ...
    const expenses = async () => {
        ...
        try {
            console.log('exp')
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/expenses/', { Eamount, Etype }, { withCredentials: true })
            getExpenses();
    ...
    const getExpenses = async () => {
        try {
            await axios.get('https://gorgeous-actually-hydrangea.glitch.me/users/getExpenses/', { withCredentials: true })
    ...
    const getProfit = () => {
        try {
            axios.get('https://gorgeous-actually-hydrangea.glitch.me/users/getProfit/', { withCredentials: true })
    ...
    const BalancDispaly = async () => {
        try {
            await axios.get('https://gorgeous-actually-hydrangea.glitch.me/users/getBalance/', { withCredentials: true })
    ...
    const LogOut = async () => {
        try {
            await axios.post('https://gorgeous-actually-hydrangea.glitch.me/users/Logout/', {}, { withCredentials: true })
        } catch (error) {
            console.error(error)
        }
    }
