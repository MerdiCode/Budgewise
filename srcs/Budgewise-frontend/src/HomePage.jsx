...
function HomePage() {
   ...
   let [goalMsg,setGoalMsg] = useState();
    ...
    useEffect(() => {
        const getGoal = async () => {
            try {
                const goal = await axios.get("https://backendbudgewise.onrender.com/users/getGoal/", { withCredentials: true });
    ...
    useEffect(() => {
        const updateBalance = async () => {
            try {
                await axios.post('https://backendbudgewise.onrender.com/users/postBalance/', { balance }, { withCredentials: true })
            } catch (error) {
                if (error) {
                    console.error(error)
                }
    ...
    useEffect(() => {
        const ProfExp = async () => {
            ...
            try {
                const AddProfVsExp = await axios.get("https://backendbudgewise.onrender.com/users/getProfVsExp/", { withCredentials: true });
    ...
    const DeleteExpensesList = async (ExpensesID) => {
        try {
            await axios.post('https://backendbudgewise.onrender.com/users/delExpenses/', { ExpensesID }, { withCredentials: true })
            getExpenses();
        } catch (error) {
            console.error(error)
        }
    ...
    const DeleteProfitList = async (ProfitID) => {
        try {
            await axios.post('https://backendbudgewise.onrender.com/users/delProfit/', { ProfitID }, { withCredentials: true })
            getProfit();
        } catch (error) {
            console.error(error)
        }
    ...
    const updateProfVsExp = async (profit, expenses) => {
        ...
        try {
            await axios.post("https://backendbudgewise.onrender.com/users/profExp/", { profExpE, profExpP }, { withCredentials: true });
        } catch (err) {
            console.error(err)
        }
    }
    const CreateGoal = async (amount) => {
        setGoalD(amount)
        try {
            await axios.post('https://backendbudgewise.onrender.com/users/updateGoal/', { amount }, { withCredentials: true })
        } catch (error) {
            if (error) {
                console.error(error)
            }
    ...
    const postProfit = async () => {
        ...
        try {
            await axios.post('https://backendbudgewise.onrender.com/users/Profit/', { profitData }, { withCredentials: true })
    ...
    const expenses = async () => {
        ...
        try {
            console.log('exp')
            await axios.post('https://backendbudgewise.onrender.com/users/expenses/', { Eamount, Etype }, { withCredentials: true })
            getExpenses();
    ...
    const getExpenses = async () => {
        try {
            await axios.get('https://backendbudgewise.onrender.com/users/getExpenses/', { withCredentials: true })
    ...
    const getProfit = () => {
        try {
            axios.get('https://backendbudgewise.onrender.com/users/getProfit/', { withCredentials: true })
    ...
    const BalancDispaly = async () => {
        try {
            await axios.get('https://backendbudgewise.onrender.com/users/getBalance/', { withCredentials: true })
